...
if(valueTextarea===""){
   ...
   textarea.classList.add("error");
    spanTextarea.textContent="le nom ne peut contenir des caracteres speciaux";
}else{
...
form.addEventListener("submit",(e) =>{
    e.preventDefault();
    if(nameForm.classList.contains("error") || surname.classList.contains("error") || textarea.classList.contains("error")){
